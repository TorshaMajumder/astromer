...
# meta_df = pd.read_csv("main-code/data/data/raw_data/ZTF/r-metadata.csv")
# print(meta_df.head())
...
if __name__ == '__main__':
    ...
    # TRAINING PAREMETERS
    parser.add_argument('--data', default='main-code/data/records/macho', type=str,
                        help='Dataset folder containing the records files')
    parser.add_argument('--p', default="main-code/runs/debug", type=str,
    ...
    parser.add_argument('--patience', default=40, type=int,
                        help='batch size')
    parser.add_argument('--gpu', default='30', type=str,
                        help='GPU to use')
